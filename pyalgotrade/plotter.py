...
from pyalgotrade import warninghelpers, broker
...
class InstrumentSubplot(Subplot):
    ...
    def onOrderEvent(self, broker_, orderEvent):
        ...
        if self.__plotBuySell and orderEvent.getEventType() in (
        broker.OrderEvent.Type.PARTIALLY_FILLED, broker.OrderEvent.Type.FILLED) and order.getInstrument() == self.__instrument:
